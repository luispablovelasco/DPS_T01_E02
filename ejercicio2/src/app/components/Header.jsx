...
export const Headers = ({
    ...
    const handleAddClick = (product) => {
        const newQuantity = inputValues[product.id]
            ? parseInt(inputValues[product.id], 10)
            : 0;
        ...
        setTotal(total + product.price * newQuantity);
        setCountProducts(countProducts + newQuantity);
        setInputValues({
            ...inputValues,
            [product.id]: '', // Clear input after adding
        });
    };
                        ...
                        <div className='row-product'>
                            {allProducts.map(product => (
                                <div className='cart-product' key={product.id}>
                                    ...
                                    <button className='btn' onClick={() => handleAddClick(product)}>Añadir</button>
